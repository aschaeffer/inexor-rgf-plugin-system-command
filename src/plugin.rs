...
use crate::behaviour::entity::entity_behaviour_provider::SystemCommandEntityBehaviourProviderImpl;
...
pub struct SystemCommandPluginImpl {
    ...
    entity_behaviour_provider: Wrc<SystemCommandEntityBehaviourProviderImpl>,
